...
dashboard.drawTable = function(){
    $.ajax({
        url: "https://databasengan.herokuapp.com/products",
        method: "GET",
        dataType : "json",
...
dashboard.remove = function(id){
    bootbox.confirm({
        ...
        callback: function (result) {
            if(result){
                $.ajax({
                    url : "https://databasengan.herokuapp.com/products/" + id,
                    method : "DELETE", //"POST"
                    dataType:'json',
                    success : function(data){
                        dashboard.drawTable();
...
dashboard.save = function(){
    if($('#formAddEditProduct').valid()){
        ...
        $.ajax({
            ...
            $.ajax({
                url : "https://databasengan.herokuapp.com/products/" + updateObj.id,
                method : "PUT",
                dataType: "json",
                contentType: "application/json",
